      ...
      <div className="bg-hero-pattern bg-cover w-screen py-96 text-rose-50">
        ...
        <div className="ml-32 absolute">
          ...
          <div
            ...
            >
            <div className="z-40 block w-40 text-black rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 dark:text-neutral-50">
              something
            </div>
          </div>
        </div>
